/*
  ...
  2. Tables
    - monthly_call_stats: Stores monthly fire and medical calls
    - yearly_call_stats: Stores yearly totals (automatically calculated)
...
DROP TABLE IF EXISTS yearly_call_stats CASCADE;
